...
for (var i=0;i<document.getElementsByClassName("slidesimg").length;i++)
document.getElementsByClassName("slidesimg")[i].addEventListener('click',function(e){myFunction(e.target);});



function displayGallery2(){
	var d=document.getElementById("gallery");
			d.style.display = "block";

		}

	function initMyFunction(imgs) {
...
document.getElementsByClassName(s)[j].style.display="none";
...
document.getElementsByClassName(s)[j].style.display="block";
	...
	function myFunction(imgs) {
	  var expandImg = document.getElementById("expandedImg");
	  // var imgText = document.getElementById("imgtext");
		$("#expandedImg").slideUp().slideDown();
setTimeout(function(){expandImg.src = imgs.src;},500);
	  // imgText.innerHTML = imgs.alt;
	  expandImg.parentElement.style.display = "block";
